...
class ValidadorCoerencia:
    ...
    ELEMENTOS_VISUAIS_POR_CATEGORIA = {
        ...
        "Longevidade": {
            "elementos_obrigatorios": [
                "idoso", "senior", "healthspan", "envelhecimento", "longevidade",
                "elderly", "aging", "long life", "care", "gentle"
            ],
            "animais": ["cão idoso", "gato senior", "senior pet", "aging dog"],
            "ambiente": ["casa", "conforto", "home", "cozy"],
            "cores_sugeridas": ["tons terra", "bege", "dourado"],
            "estilo": "calmo, digno"
        },
        "Idosos": { # Alias para compatibilidade
            "elementos_obrigatorios": ["idoso", "senior", "elderly", "aging"],
            "animais": ["senior pet", "cão idoso", "gato idoso"],
            "ambiente": ["home", "cozy"],
            "cores_sugeridas": ["bege", "tons terra"],
            "estilo": "calmo"
        },
        "Small Pets": {
            "elementos_obrigatorios": [
                "porquinho da índia", "guinea pig", "roedor", "hamster", "roedor",
                "macro", "small", "tiny", "rodent", "cavy", "whiskers"
            ],
            "animais": ["guinea pig", "porquinho", "roedor", "hamster"],
            "ambiente": ["hay", "feno", "garden", "macro setting"],
            "cores_sugeridas": ["verde", "amarelo"],
            "estilo": "macro, detalhado"
        }
    }
    ...
    PALAVRAS_CHAVE_CRITICAS = {
        ...
        "saúde": ["saúde", "cuidado", "tratamento", "health", "care", "wellness"],
        "porquinho": ["guinea pig", "porquinho", "roedor", "rodent", "macro"],
        "zoomies": ["playing", "running", "joyful", "active", "behavior"],
        "stress": ["anxious", "stress", "calm", "body language", "posture"],
        "freeze-dried": ["food", "nutrition", "kibble", "premium"],
        "hidratação": ["water", "drinking", "fountain", "hydration", "cat drinking"]
    }
    ...
    def validar_categoria_vs_prompt(
        ...
        tem_animal = False
        keywords_animais = ["cao", "gato", "cachorro", "pet", "animal", "dog", "cat", "puppy", "kitten", "retriever", "tabby", "beagle", "felino", "canino", "guinea pig", "porquinho", "roedor", "rodent", "hamster"]
