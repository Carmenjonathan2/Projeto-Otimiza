...
```mermaid
graph TD
    A[1. Primeiro Contato & Cotação] --> B[2. Cadastro do Tutor / CRM]
    B --> C[3. Fechamento & Espelho do Pedido]
    C --> D[4. Logística, Envio & Código de Entrega]
    D --> E[5. Pós-Venda & Fidelização LTV]
```
