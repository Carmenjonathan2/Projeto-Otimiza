...
console.log("Starting default cache session diagnostic...");
...
async function run() {
    try {
        ...
        console.log("Waiting 30 seconds for default version cache page to load...");
        await new Promise(resolve => setTimeout(resolve, 30000));
        
        console.log("Taking screenshot...");
        if (client.pupPage) {
            await client.pupPage.screenshot({ path: path.join(__dirname, 'whatsapp_screenshot_default.png') });
            console.log("Screenshot saved to whatsapp_screenshot_default.png");
