...
// Hook de monitoramento de custo (opcional — registra cada chamada se disponível)
...
// Self-test: rodar `node responder_dm.js --self-test` para uma chamada de prova
if (require.main === module && process.argv.includes('--self-test')) {
    (async () => {
        try {
            console.log('[SELF-TEST] responder_dm.js — chamando Gemini com mensagem fixa...');
            const resposta = await gerarRespostaDM('selftest-user', 'Oi, tudo bem?');
